...
if __name__ == "__main__":
    ...
    fitness_ppa_b = np.sum(results_ppa_b[1], axis=3)
    fitness_ppa_c = np.sum(results_ppa_c[1], axis=3)
    fitness_pso = np.sum(results_pso[1], axis=3)
    fitness_ga = np.sum(results_ga[1], axis=3)
    fitness_de = np.sum(results_de[1], axis=3)
    ...
    mean_partial_ppa_b = np.mean(results_ppa_b[1], axis=(0, 1))
    mean_partial_ppa_c = np.mean(results_ppa_c[1], axis=(0, 1))
    mean_partial_pso = np.mean(results_pso[1], axis=(0, 1))
    mean_partial_ga = np.mean(results_ga[1], axis=(0, 1))
    mean_partial_de = np.mean(results_de[1], axis=(0, 1))
    ...
    #     plt.ylabel('valor da avaliação')
    #     plt.ylim((3, 13))
    #     plt.plot(results_ppa_b[0], (mean_ppa_b[i] + mean_ppa_b[i + 3]) * 0.5, color='#4daf4a', label="APPD")
    #     plt.plot(results_ppa_c[0], (mean_ppa_c[i] + mean_ppa_c[i + 3]) * 0.5, color='#f781bf', label="APPC")
    #     plt.plot(results_pso[0], (mean_pso[i] + mean_pso[i + 3]) * 0.5, color='#a65628', label="OEP")
    #     plt.plot(results_ga[0], (mean_ga[i] + mean_ga[i + 3]) * 0.5, color='#377eb8', label="AG")
    #     plt.plot(results_de[0], (mean_de[i] + mean_de[i + 3]) * 0.5, color='#ff7f00', label="ED")
    #     plt.legend(loc=1)
    ...
    #         plt.plot(results_ppa_c[0], results_ppa_c[1][j, i])
    #         plt.plot(results_ppa_c[0], results_ppa_c[1][j, i+3])
    #
